...
VALUES (1, N'dharmindersk', N'EmailScheduler.Tasks.BasicEmailTask', N'Send update today before first half', N'New', CAST(0x0000A322001774A2 AS DateTime), N'Once', CAST(0x0000A3220015896B AS DateTime))
SET IDENTITY_INSERT [dbo].[Tasks] OFF
/****** Object:  Table [dbo].[Attributes]    Script Date: 05/08/2014 20:37:57 ******/
INSERT [dbo].[TaskAttributes] ([task_id], [attr_name], [attr_value]) VALUES (2, N'email_message', N'activty report <p> Regards <BR /> DSK</p> ')
